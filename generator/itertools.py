...
it = itertools.chain([1, 2, 3], [4, 5, 6], [7, 8, 9])
print(list(it))
...
values2 = [1, 2, 3, 4, 5, 6, 7, 1, 9, 10]
less_than_seven = lambda x: x < 7
it = itertools.dropwhile(less_than_seven, values1)
print(list(it))

it = itertools.dropwhile(less_than_seven, values2)
print(list(it))
